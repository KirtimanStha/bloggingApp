...
<div class="content-wrapper">
  @if(count($errors)>0)
    ...
    @endforeach
  @endif
	<h1 class="text-center align-content-center">Edit Blog </h1>
<!-- Card Start -->
<div class="card card-primary">
  ...
  <form role="form" method="POST" action="{{ route('blog.update', $blog->id)}}">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        <div class="container">
          <img src="{{ Storage::disk('local')->url($blog->image) }}" height="100px" width="100px">
        </div>
        <label for="exampleInputFile">File input</label>
        <div class="input-group">
          <div class="custom-file">
            <input type="file" class="custom-file-input" id="image" name="image" value="{{ $blog->image }}">
